...
def run_random_search(subjects, confidence_types, patience_values, threshold_values, initial_window_length, expansion_rate, sfreq, csp_components, c, kernel, gamma, degree):
    best_itr_tune = 0
    ...
    for iteration in range(iterations):
        ...
        for threshold in threshold_values:
            accuracy, kappa, prediction_time, _, _, _, _  = run_expanding_classification_dynamic(
                subjects, threshold, patience, confidence_type, initial_window_length, expansion_rate, sfreq, csp_components, c, kernel, gamma, degree
            )
