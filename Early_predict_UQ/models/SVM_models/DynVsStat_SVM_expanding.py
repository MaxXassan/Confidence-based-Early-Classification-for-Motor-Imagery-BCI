...
from Tune_SVM_expanding import tune_svm_expanding
...
def plot_confusion_matrix(cm_stat, cm_dyn):
    ...
    plt.savefig(
        project_root
        + "/reports/figures/cumulative/SVM/dynamicVSstatic/Expanding_dynamic_ConfusionMatrix.png"
    )
    ...
    plt.savefig(
        project_root
        + "/reports/figures/cumulative/SVM/dynamicVSstatic/Expanding_static_ConfusionMatrix.png"
    )
...
def main_svm_expanding():
    ...
    # best_params_expanding, best_itr_patience, _ = tune_svm_expanding()
    ...
    print(
        "Evaluation (2):Finding static model accuracy, and kappa for the given prediction times from the dynamic model"
    )
    ...
    h = open(
        project_root
        + "/reports/figures/cumulative/SVM/dynamicVSstatic/expanding_model_optimal_parameters.txt",
        "w",
    )
    h.write(
        f"Chosen parameters: \n - csp: {csp_components}, \n - kernel: {kernel}, \n - C: {c}, \n - gamma: {gamma}, \n - initial_window_length: {initial_window_length}\n - expansion-rate:  {expansion_rate} \n - confidence_type: {best_confidence_type}, \n - patience: {best_itr_patience} out of {patience_values}"
    ...
    f = open(
        project_root
        + "/reports/figures/cumulative/SVM/dynamicVSstatic/expanding_dynamic_model_accuracy_by_subject.txt",
        "w",
    )
    ...
    f = open(
        project_root
        + "/reports/figures/cumulative/SVM/dynamicVSstatic/expanding_static_model_accuracy_by_subject.txt",
        "w",
    )
    ...
    f = open(
        project_root
        + "/reports/figures/cumulative/SVM/dynamicVSstatic/expanding_dynamic_model_kappa_by_subject.txt",
        "w",
    )
    ...
    f = open(
        project_root
        + "/reports/figures/cumulative/SVM/dynamicVSstatic/expanding_static_model_kappa_by_subject.txt",
        "w",
    )
    ...
    f = open(
        project_root
        + "/reports/figures/cumulative/SVM/dynamicVSstatic/expanding_dynamic_model_itrs_by_subject.txt",
        "w",
    )
    ...
    f = open(
        project_root
        + "/reports/figures/cumulative/SVM/dynamicVSstatic/expanding_static_model_itrs_by_subject.txt",
        "w",
    )
    ...
    f = open(
        project_root
        + "/reports/figures/cumulative/SVM/dynamicVSstatic/expanding_dynamic_model_predtime_by_subject.txt",
        "w",
    )
    f.write(
    ...
    plt.savefig(
        project_root
        + "/reports/figures/cumulative/SVM/dynamicVSstatic/ExpandingAccuracy.png"
    )
    plt.show()
    ...
    plt.savefig(
        project_root
        + "/reports/figures/cumulative/SVM/dynamicVSstatic/ExpandingKappa.png"
    )
    plt.show()
    ...
    plt.savefig(
        project_root
        + "/reports/figures/cumulative/SVM/dynamicVSstatic/ExpandingItr.png"
    )
    plt.show()
