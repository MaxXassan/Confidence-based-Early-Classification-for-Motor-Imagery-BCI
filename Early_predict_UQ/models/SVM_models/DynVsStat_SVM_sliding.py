...
from Tune_SVM_sliding import tune_svm_sliding
...
def run_sliding_classification_static(
    subjects, w_length, w_step, csp_components, c, kernel, gamma, degree, time
):
    scores_across_subjects = []
    kappa_across_subjects = []
    itrs_across_subjects = []
...
def plot_confusion_matrix(cm_stat, cm_dyn):
    ...
    plt.savefig(
        project_root
        + "/reports/figures/cumulative/SVM/dynamicVSstatic/Sliding_dynamic_ConfusionMatrix.png"
    )
    ...
    plt.savefig(
        project_root
        + "/reports/figures/cumulative/SVM/dynamicVSstatic/Sliding_static_ConfusionMatrix.png"
    )
...
def main_svm_sliding():
    ...
    for i, time in enumerate(prediction_time_dynamic):
        ...
        accuracy_static.append(accuracy_stat)
        kappa_static.append(
            kappa_stat,
        )
    ...
    h = open(
        project_root
        + "/reports/figures/cumulative/SVM/dynamicVSstatic/sliding_model_optimal_parameters.txt",
        "w",
    )
    h.write(
        f"Chosen parameters: \n - csp: {csp_components}, \n - w_length: {w_length},\n - w_step:  {w_step}, \n - confidence_type: {best_confidence_type}, \n - patience: {best_itr_patience} out of {patience_values}"
    ...
    f = open(
        project_root
        + "/reports/figures/cumulative/SVM/dynamicVSstatic/sliding_dynamic_model_accuracy_by_subject.txt",
        "w",
    )
    ...
    f = open(
        project_root
        + "/reports/figures/cumulative/SVM/dynamicVSstatic/sliding_static_model_accuracy_by_subject.txt",
        "w",
    )
    ...
    f = open(
        project_root
        + "/reports/figures/cumulative/SVM/dynamicVSstatic/sliding_dynamic_model_kappa_by_subject.txt",
        "w",
    )
    ...
    f = open(
        project_root
        + "/reports/figures/cumulative/SVM/dynamicVSstatic/sliding_static_model_kappa_by_subject.txt",
        "w",
    )
    ...
    f = open(
        project_root
        + "/reports/figures/cumulative/SVM/dynamicVSstatic/sliding_dynamic_model_itrs_by_subject.txt",
        "w",
    )
    ...
    f = open(
        project_root
        + "/reports/figures/cumulative/SVM/dynamicVSstatic/sliding_static_model_itrs_by_subject.txt",
        "w",
    )
    ...
    f = open(
        project_root
        + "/reports/figures/cumulative/SVM/dynamicVSstatic/sliding_dynamic_model_predtime_by_subject.txt",
        "w",
    )
    f.write(
    ...
    plt.savefig(
        project_root
        + "/reports/figures/cumulative/SVM/dynamicVSstatic/SlidingAccuracy.png"
    )
    plt.show()
    ...
    plt.savefig(
        project_root
        + "/reports/figures/cumulative/SVM/dynamicVSstatic/SlidingKappa.png"
    )
    plt.show()
    ...
    plt.ylim(bottom=0)
    plt.savefig(
        project_root + "/reports/figures/cumulative/SVM/dynamicVSstatic/SlidingItr.png"
    )
    plt.show()
