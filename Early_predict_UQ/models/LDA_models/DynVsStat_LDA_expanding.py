...
def run_expanding_classification_static(subjects, initial_window_length, expansion_rate, csp_components, time, solver, shrinkage, n_components, tol):
    scores_across_subjects = []
    kappa_across_subjects = []
    itrs_across_subjects = []
...
def main_lda_expanding():
    ...
    for i, time in enumerate(prediction_time_dynamic):
        ...
        accuracy, kappa, _, subjects_accuracies_stat, mean_scores_across_subjects_stat, subjects_kappa_stat, mean_kappa_across_subjects_stat, subjects_itrs_stat, _,  cm_stat, csp_stat = run_expanding_classification_static(subjects, initial_window_length, expansion_rate, csp_components, time, solver, shrinkage, n_components, tol)
