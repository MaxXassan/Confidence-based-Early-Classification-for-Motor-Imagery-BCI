...
def run_expanding_classification_tuning_static(subjects, initial_window_length, expansion_rate, csp_components, pred_times = False):
    scores_across_subjects = []
    kappa_across_subjects = []
...
def run_expanding_classification_static(subjects, initial_window_length, expansion_rate, csp_components, pred_times = False):
    scores_across_subjects = []
    kappa_across_subjects = []
...
def main_lda_expanding():
    ...
    for n, threshold in enumerate(threshold_values):
        ...
        accuracy, kappa, prediction_time, cm_dyn, subjects_accuracies_dyn, subjects_prediction_times_dyn, subjects_kappa_dyn = run_expanding_classification_dynamic(subjects, threshold, best_itr_patience, best_confidence_type, initial_window_length, expansion_rate, sfreq, csp_components)
    ...
    accuracy_static = []
    kappa_static= []
    subjects_accuracies_stat, scores_across_subjects_stat, subjects_kappa_stat, kappa_across_subjects_stat, accuracy, kappa, cm_stat, _ = run_expanding_classification_static(subjects, initial_window_length, expansion_rate, csp_components, prediction_time_dynamic)
    ...
    h = open(project_root + "/reports/figures/cumulative/LDA/dynamicVSstatic/expanding_model_optimal_parameters", "w")
    ...
    f = open(project_root + "/reports/figures/cumulative/LDA/dynamicVSstatic/expanding_dynamic_model_accuracy_by_subject", "w")
    ...
    f = open(project_root + "/reports/figures/cumulative/LDA/dynamicVSstatic/expanding_static_model_accuracy_by_subject", "w")
    ...
    sorted_subjects = sorted(subject_tuples, key=lambda x: x[1], reverse=True)
    f = open(project_root + "/reports/figures/cumulative/LDA/dynamicVSstatic/expanding_dynamic_model_kappa_by_subject", "w")
    ...
    f = open(project_root + "/reports/figures/cumulative/LDA/dynamicVSstatic/expanding_static_model_kappa_by_subject", "w")
    ...
    sorted_subjects = sorted(subject_tuples, key=lambda x: x[1], reverse=True)
    f = open(project_root + "/reports/figures/cumulative/LDA/dynamicVSstatic/expanding_dynamic_model_predtime_by_subject", "w")
