...
def main_lda_sliding():
    ...
    for confidence_type in confidence_types:
        ...
        for n, threshold in enumerate(threshold_values):
            ...
            for m, patience in enumerate(patience_values):
                ...
                accuracy, kappa, prediction_time, _, _, _ , _ = run_sliding_classification_dynamic(subjects, threshold, patience, confidence_type, w_length, w_step, sfreq, csp_components)
    ...
    for n, threshold in enumerate(threshold_values):
        ...
        accuracy, kappa, prediction_time, cm_dyn, subjects_accuracies_dyn, subjects_prediction_times_dyn, subjects_kappa_dyn = run_sliding_classification_dynamic(subjects, threshold, best_itr_patience, best_confidence_type, w_length, w_step, sfreq, csp_components)
    ...
    h = open(project_root + "/reports/figures/cumulative/LDA/dynamicVSstatic/sliding_model_optimal_parameters", "w")
    ...
    f = open(project_root + "/reports/figures/cumulative/LDA/dynamicVSstatic/sliding_dynamic_model_accuracy_by_subject", "w")
    ...
    f = open(project_root + "/reports/figures/cumulative/LDA/dynamicVSstatic/sliding_static_model_accuracy_by_subject", "w")
    ...
    sorted_subjects = sorted(subject_tuples, key=lambda x: x[1], reverse=True)
    f = open(project_root + "/reports/figures/cumulative/LDA/dynamicVSstatic/sliding_dynamic_model_kappa_by_subject", "w")
    ...
    f = open(project_root + "/reports/figures/cumulative/LDA/dynamicVSstatic/sliding_static_model_kappa_by_subject", "w")
    ...
    sorted_subjects = sorted(subject_tuples, key=lambda x: x[1], reverse=True)
    f = open(project_root + "/reports/figures/cumulative/LDA/dynamicVSstatic/sliding_dynamic_model_predtime_by_subject", "w")
