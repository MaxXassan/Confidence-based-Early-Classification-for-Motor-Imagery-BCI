...
def run_sliding_classification_dynamic(
    subjects,
    threshold,
    patience,
    confidence_type,
...
def run_sliding_classification_static(
    subjects,
    w_length,
    w_step,
    csp_components,
...
def plot_confusion_matrix(cm_stat, cm_dyn):
    ...
    plt.savefig(
        project_root
        + "/reports/figures/cumulative/LDA/dynamicVSstatic/Sliding_dynamic_ConfusionMatrix.png"
    )
    ...
    plt.savefig(
        project_root
        + "/reports/figures/cumulative/LDA/dynamicVSstatic/Sliding_static_ConfusionMatrix.png"
    )
...
def main_lda_sliding():
    ...
    # best_params_sliding, best_itr_patience, _ = tune_lda_sliding()
    best_itr_patience = 5
    ...
    for n, threshold in enumerate(threshold_values):
        ...
        (
            ...
            mean_prediction_time_across_subjects,
            _,
        ) = run_sliding_classification_dynamic(
            subjects,
            threshold,
            best_itr_patience,
    ...
    for i, time in enumerate(prediction_time_dynamic):
        ...
        (
            ...
            cm_stat,
            csp_stat,
        ) = run_sliding_classification_static(
            subjects,
            w_length,
            w_step,
            csp_components,
    ...
    h = open(
        project_root
        + "/reports/figures/cumulative/LDA/dynamicVSstatic/sliding_model_optimal_parameters.txt",
        "w",
    )
    h.write(
        f"Chosen parameters: \n - csp: {csp_components}, \n - w_length: {w_length},\n - w_step:  {w_step}, \n - solver : {solver}, \n - shrinkage: {shrinkage}, \n - confidence_type: {best_confidence_type}, \n - patience: {best_itr_patience} out of {patience_values}"
    ...
    f = open(
        project_root
        + "/reports/figures/cumulative/LDA/dynamicVSstatic/sliding_dynamic_model_accuracy_by_subject.txt",
        "w",
    )
    ...
    f = open(
        project_root
        + "/reports/figures/cumulative/LDA/dynamicVSstatic/sliding_static_model_accuracy_by_subject.txt",
        "w",
    )
    ...
    f = open(
        project_root
        + "/reports/figures/cumulative/LDA/dynamicVSstatic/sliding_dynamic_model_kappa_by_subject.txt",
        "w",
    )
    ...
    f = open(
        project_root
        + "/reports/figures/cumulative/LDA/dynamicVSstatic/sliding_static_model_kappa_by_subject.txt",
        "w",
    )
    ...
    f = open(
        project_root
        + "/reports/figures/cumulative/LDA/dynamicVSstatic/sliding_dynamic_model_itrs_by_subject.txt",
        "w",
    )
    ...
    f = open(
        project_root
        + "/reports/figures/cumulative/LDA/dynamicVSstatic/sliding_static_model_itrs_by_subject.txt",
        "w",
    )
    ...
    f = open(
        project_root
        + "/reports/figures/cumulative/LDA/dynamicVSstatic/sliding_dynamic_model_predtime_by_subject.txt",
        "w",
    )
    f.write(
    ...
    plt.savefig(
        project_root
        + "/reports/figures/cumulative/LDA/dynamicVSstatic/SlidingAccuracy.png"
    )
    plt.show()
    ...
    plt.savefig(
        project_root
        + "/reports/figures/cumulative/LDA/dynamicVSstatic/SlidingKappa.png"
    )
    plt.show()
    ...
    plt.ylim(bottom=0)
    plt.savefig(
        project_root + "/reports/figures/cumulative/LDA/dynamicVSstatic/SlidingItr.png"
    )
    plt.show()
